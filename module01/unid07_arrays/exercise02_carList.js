...
contador. Use o console.log para exibir o nome dos carros de acordo com o exemplo
abaixo:
 * “Nome do Carro: NOME_DO_CARRO”
 *
 */

let carList = ["Space Fox", "Gol GTX", "Jeep Renegade", "Fusca 1600", "Kombi Ninja"];

for (let i = 0; i < carList.length; i++) {
    console.log("Nome do carro: " + carList[i].replace(" ", "_").toUpperCase());
};